...
class UploadHandler {
    ...
    public function combineChunks($uploadDirectory,$proptery_code) {
        $uuid = $_POST['qquuid'];
        $name = $this->getName();

      #  $targetFolder = $this->chunknksFolder.DIRECTORY_SEPARATOR.$uuid;
        $targetFolder = $proptery_code;
    ...
    public function handleUpload($uploadDirectory, $name = null){
        ...
        if(!isset($type)) {
            ...
            return array('type'=> $type, 'error' => "Server error. Not a multipart request. Please set forceMultipart to default value (true).");
        }
